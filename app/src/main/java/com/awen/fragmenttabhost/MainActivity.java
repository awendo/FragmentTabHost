...
public class MainActivity extends FragmentActivity implements
    ...
    private int imageViewArray[] = { R.drawable.tab_home_btn, R.drawable.tab_view_btn ,R.drawable.tab_home_btn,R.drawable.tab_view_btn};
    private String textViewArray[] = { "首页", "分类","附件","我的"};
